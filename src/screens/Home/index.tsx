        ...
        >
            ...
            <HeaderSection>
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <McText secondary size={28} color={theme.colors.text1}>Foodajo</McText>
                </View>
                <McImage source={Images.union} style={{width: 19, height: 19, tinColor: theme.colors.text2}} />
            </HeaderSection>
